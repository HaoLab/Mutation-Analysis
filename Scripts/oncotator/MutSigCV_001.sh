...
AWD_NED=$1/tumor_001.maf
CD=$1/lymp_001.maf
output_AWD=$1/tumor
output_CD=$1/lymp

$MutSigCV $MCR $AWD_NED $cov_file $gene_covariates $output_AWD/tumor_001 $mutation_type_dictionary_file $chr_files_hg19
#$MutSigCV $MCR $CD $cov_file $gene_covariates $output_CD/lymp_001 $mutation_type_dictionary_file $chr_files_hg19
