...
$MutSigCV $MCR $AWD_NED $cov_file $gene_covariates $output_AWD/tumor $mutation_type_dictionary_file $chr_files_hg19
$MutSigCV $MCR $CD $cov_file $gene_covariates $output_CD/lymp $mutation_type_dictionary_file $chr_files_hg19
